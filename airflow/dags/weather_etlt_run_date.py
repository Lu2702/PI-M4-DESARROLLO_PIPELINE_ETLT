...
# Flags Spark: evitar usar /opt/etlt/app para artefactos/temp
SPARK_CONFS = (
...
with DAG(
    dag_id=DAG_ID,
    description="OpenWeather ETLT manual: SILVER->GOLD por fecha; GOLD con baseline 2024 (artefacts en /tmp)",
    ...
    precheck = SSHOperator(
        ...
        command=(
            ...
            "set -euo pipefail; "
            "mkdir -p " + ARTIF_DIR + " " + WAREHOUSE_DIR + " ; "
